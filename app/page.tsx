  ...
  return (
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "ClickVente - Web & AI Automation Agency",
            ...
            "mainEntity": {
              "@type": "Organization",
              "name": "ClickVente",
              "description": "Web & AI Automation Agency",
              "url": "https://clickvente.com",
              "hasOfferCatalog": {
                "@type": "OfferCatalog",
                "name": "Web Development and AI Automation Services",
                "itemListElement": [
                  {
                    "@type": "Offer",
                    "itemOffered": {
                  ...
                  },
                  {
                    ...
                    "itemOffered": {
                      ...
                      "description": "AI-powered chatbots and workflow automation"
                    }
                  },
                  {
                    "@type": "Offer",
      ...
      <main className="min-h-screen">
        {/* Navigation */}
        <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md z-50 shadow-sm border-b border-primary-100" role="navigation" aria-label="Main navigation">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center">
                <div className="text-3xl font-bold" role="banner">
                  <span className="text-secondary-900">Click</span>
                  <span className="text-primary-500">Vente</span>
                </div>
              </div>
              <div className="hidden md:flex space-x-8 items-center">
                <a href="#about" className="text-secondary-700 hover:text-primary-500 transition-colors font-medium" aria-label="About us section">{t('nav.about')}</a>
                <a href="#services" className="text-secondary-700 hover:text-primary-500 transition-colors font-medium" aria-label="Our services section">{t('nav.services')}</a>
                <a href="#results" className="text-secondary-700 hover:text-primary-500 transition-colors font-medium" aria-label="Results section">Results</a>
                <a href="#contact" className="text-secondary-700 hover:text-primary-500 transition-colors font-medium" aria-label="Contact us section">{t('nav.contact')}</a>
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 pb-12" role="banner">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-8 sm:py-12">
            <div className="animate-fade-in">
              ...
              <div className="flex justify-center px-4">
                ...
                >
                  {t('hero.cta')}
                  <ArrowRight className="inline-block ml-2 h-4 w-4 sm:h-5 sm:w-5" aria-hidden="true" />
                </button>
              </div>
            </div>
          </div>
          ...
          {/* Scroll indicator */}
          <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce" aria-hidden="true">
        ...
        <section id="about" className="relative py-16 sm:py-20 md:py-24 lg:py-32 section-gradient overflow-hidden" role="region" aria-labelledby="about-heading">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              <article className="space-y-6 sm:space-y-8 px-4">
                ...
                <div className="bg-gradient-to-br from-primary-500 to-secondary-800 rounded-2xl p-6 sm:p-8 lg:p-10 text-white">
                  ...
                  <ul className="space-y-3 sm:space-y-4" role="list">
                    <li className="flex items-center">
                      <Globe className="h-5 w-5 sm:h-6 sm:w-6 mr-3 sm:mr-4 flex-shrink-0" aria-hidden="true" />
                      <span className="text-base sm:text-lg">{t('about.benefits.websites')}</span>
                    </li>
                    <li className="flex items-center">
                      <Zap className="h-5 w-5 sm:h-6 sm:w-6 mr-3 sm:mr-4 flex-shrink-0" aria-hidden="true" />
                      <span className="text-base sm:text-lg">{t('about.benefits.automation')}</span>
                    </li>
                    <li className="flex items-center">
                      <Target className="h-5 w-5 sm:h-6 sm:w-6 mr-3 sm:mr-4 flex-shrink-0" aria-hidden="true" />
                      <span className="text-base sm:text-lg">{t('about.benefits.integration')}</span>
                    </li>
                    <li className="flex items-center">
                      <Bot className="h-5 w-5 sm:h-6 sm:w-6 mr-3 sm:mr-4 flex-shrink-0" aria-hidden="true" />
        ...
        <section id="services" className="relative py-16 sm:py-20 md:py-24 lg:py-32 bg-white overflow-hidden" role="region" aria-labelledby="services-heading">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12" role="list">
              {/* Custom Web Development */}
              <article className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 card-hover border border-primary-100" role="listitem">
                <div className="bg-primary-100 rounded-lg p-3 sm:p-4 w-fit mb-6 sm:mb-8">
                  <Globe className="h-8 w-8 sm:h-10 sm:w-10 text-primary-600" aria-hidden="true" />
                </div>
                ...
                <ul className="space-y-2 sm:space-y-3 mb-6 sm:mb-8" role="list">
                  <li className="flex items-center text-secondary-600">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-primary-500 mr-2 sm:mr-3 flex-shrink-0" aria-hidden="true" />
              ...
              <article className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 card-hover border border-primary-100" role="listitem">
                <div className="bg-accent-100 rounded-lg p-3 sm:p-4 w-fit mb-6 sm:mb-8">
                  <Zap className="h-8 w-8 sm:h-10 sm:w-10 text-accent-600" aria-hidden="true" />
                </div>
              ...
              <article className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 card-hover border border-primary-100" role="listitem">
                <div className="bg-secondary-100 rounded-lg p-3 sm:p-4 w-fit mb-6 sm:mb-8">
                  <Target className="h-8 w-8 sm:h-10 sm:w-10 text-secondary-600" aria-hidden="true" />
                </div>
              ...
              <article className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 card-hover border border-primary-100" role="listitem">
                <div className="bg-primary-100 rounded-lg p-3 sm:p-4 w-fit mb-6 sm:mb-8">
                  <Bot className="h-8 w-8 sm:h-10 sm:w-10 text-primary-600" aria-hidden="true" />
                </div>
              ...
              <article className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10 card-hover border border-primary-100" role="listitem">
                <div className="bg-accent-100 rounded-lg p-3 sm:p-4 w-fit mb-6 sm:mb-8">
                  <Globe className="h-8 w-8 sm:h-10 sm:w-10 text-accent-600" aria-hidden="true" />
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
              ...
              <div className="text-center px-4">
                <div className="bg-primary-100 rounded-full p-4 sm:p-6 w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 flex items-center justify-center">
                  <Globe className="h-10 w-10 sm:h-12 sm:w-12 text-primary-600" aria-hidden="true" />
                </div>
              ...
              <div className="text-center px-4">
                <div className="bg-accent-100 rounded-full p-4 sm:p-6 w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 flex items-center justify-center">
                  <Bot className="h-10 w-10 sm:h-12 sm:w-12 text-accent-600" aria-hidden="true" />
                </div>
              ...
              <div className="text-center px-4">
                <div className="bg-secondary-100 rounded-full p-4 sm:p-6 w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 flex items-center justify-center">
                  <Zap className="h-10 w-10 sm:h-12 sm:w-12 text-secondary-600" aria-hidden="true" />
                </div>
              ...
              <div className="text-center px-4">
                <div className="bg-primary-100 rounded-full p-4 sm:p-6 w-20 h-20 sm:w-24 sm:h-24 mx-auto mb-4 sm:mb-6 flex items-center justify-center">
                  <Target className="h-10 w-10 sm:h-12 sm:w-12 text-primary-600" aria-hidden="true" />
                </div>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-20 bg-gradient-to-r from-primary-500 to-secondary-800 rounded-2xl p-8 sm:p-12 md:p-16 text-center text-white mx-4">
              ...
              >
                ...
                <ArrowRight className="inline-block ml-2 sm:ml-3 h-5 w-5 sm:h-6 sm:w-6" aria-hidden="true" />
              </button>
            </div>
          </div>
        </section>
                ...
                <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8 lg:p-10">
                  <div className="flex items-center mb-6">
                    <div className="bg-primary-100 rounded-lg p-3 sm:p-4 mr-4 sm:mr-6">
                      <Mail className="h-6 w-6 sm:h-8 sm:w-8 text-primary-600" aria-hidden="true" />
                    </div>
                    <div>
              ...
              <div className="bg-gradient-to-br from-white to-primary-50/30 rounded-2xl p-8 sm:p-10 lg:p-12 shadow-xl max-w-5xl mx-auto border border-primary-100/50">
                    ...
                    <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg border border-primary-100/50 group-hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center justify-center mb-4 sm:mb-6">
                        <div className="bg-primary-100 rounded-lg p-3 sm:p-4">
                          <MessageCircle className="h-6 w-6 sm:h-8 sm:w-8 text-primary-600" aria-hidden="true" />
                        </div>
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg border border-primary-100/50 group-hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center justify-center mb-4 sm:mb-6">
                        <div className="bg-secondary-100 rounded-lg p-3 sm:p-4">
                          <Target className="h-6 w-6 sm:h-8 sm:w-8 text-secondary-600" aria-hidden="true" />
                        </div>
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg border border-primary-100/50 group-hover:shadow-xl transition-all duration-300">
                      <div className="flex items-center justify-center mb-4 sm:mb-6">
                        <div className="bg-accent-100 rounded-lg p-3 sm:p-4">
                          <Zap className="h-6 w-6 sm:h-8 sm:w-8 text-accent-600" aria-hidden="true" />
                        </div>
                      </div>
                ...
                <div className="text-center mt-10 sm:mt-12 pt-6 sm:pt-8 border-t border-primary-200/50">
                  ...
                  <div className="flex items-center justify-center space-x-2 sm:space-x-3 text-secondary-500 text-sm sm:text-base">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-primary-500" aria-hidden="true" />
